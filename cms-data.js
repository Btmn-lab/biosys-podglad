// Dane treści strony BioSys — źródło dla panelu CMS.
// Wygenerowane z pliku „BioSys Landing Pages -publikacja-.dc.html”. Nie edytować ręcznie.
const RES = (id, url) => url;
...
const PAGES = [
{
  ...
  ctaShort:'Umów analizę procesu', secondaryCta:'Oblicz potencjał oszczędności',
  ...
  dashTitle:'Obecność i czas pracy', stats:[{label:'Obecni teraz',value:'183'},{label:'Nieobecni',value:'8'},{label:'Wnioski do decyzji',value:'12'}], barVals:[45,58,68,50,62,48,72,80,58]
},
{
...
},
{
  ...
  title1:'Kariera w BioSys.', title2:'Dołącz do zespołu BioSys.',
  intro:'Jesteśmy BioSys. Tworzymy zaawansowane oprogramowanie i produkujemy urządzenia, które pomagają firmom efektywnie zarządzać czasem pracy oraz dbać o bezpieczeństwo na terenie całego kraju. Nie jesteśmy sztywną korporacją — stawiamy na proste zasady, partnerskie relacje, merytoryczne działanie i brak zbędnej biurokracji.',
  ...
  contactCols:[
    {
      badge:'OBECNI KLIENCI', title:'Zgłoszenia serwisowe',
      lead:'Zgłoszenie zakładasz w Panelu Klienta — trafia od razu do właściwego opiekuna technicznego, razem z historią Twojej instalacji. Opiekun kontaktuje się z Tobą i prowadzi sprawę do końca, także telefonicznie, jeśli tak będzie szybciej.',
      rows:[{k:'Zgłoszenie',v:'Panel Klienta'},{k:'Prowadzenie sprawy',v:'opiekun techniczny'},{k:'Aktualizacje systemu',v:'Panel Klienta'},{k:'Status i historia',v:'widoczne w panelu'}],
      cta:'Przejdź do Panelu Klienta', accent:'#0F766E'
    },
    {
      badge:'NOWI KLIENCI', title:'Bezpłatna analiza Twoich procesów',
      lead:'Zaczynamy od tego, jak dziś rejestrujecie czas pracy i gdzie proces się zacina. Na tej podstawie pokazujemy, jak działa u nas system w podobnych organizacjach.',
      rows:[{k:'Telefon',v:'+48 12 378 95 37'},{k:'E-mail',v:'kontakt@biosys.pl'},{k:'Godziny pracy',v:'pon.–pt. 8:00–16:00'}],
      cta:'Umów analizę', accent:'#2563EB'
    }
  ]
},
{
...
},
{
  ...
  solPainsTitle:'Jeżeli mierzysz się choćby z jednym z wyzwań:',
  painsKicker:'SYTUACJE I ROZWIĄZANIA',
  painsTitlePre:'Jeżeli mierzysz się choćby z ', painsTitleHi:'jednym z wyzwań:', painsLead:'Dziesięć sytuacji, które firmy opisują nam przed wdrożeniem, i sposób, w jaki system je porządkuje.',
  solPains:[
    {t:'Papierowa lista obecności',d:'Podpis na liście nie zawiera dokładnej godziny wejścia i wyjścia.',s:'Elektroniczny rejestrator rejestruje dokładny czas co do sekundy. Zero ręcznego dopisywania i fałszowania godzin.'},
    {t:'Potwierdzenie tożsamości przy rejestracji',d:'Sama rejestracja kartą nie pokazuje, kto przyłożył identyfikator.',s:'Moduł foto-rejestracji. Płacisz wyłącznie za obecność osoby, która faktycznie zarejestrowała swoją kartę.'},
    {t:'Spóźnienia i wcześniejsze wyjścia',d:'Bez pomiaru trudno rozliczać odstępstwa od grafiku jednakowo w całym zespole.',s:'System automatycznie wyłapuje każde spóźnienie i wcześniejsze wyjście. Masz twarde dane do egzekwowania regulaminu i sprawiedliwego traktowania reszty załogi.'},
    {t:'Wyjścia prywatne w ciągu dnia',d:'Krótkie wyjścia poza zakład nie są nigdzie odnotowywane.',s:'Dedykowany przycisk „Wyjście prywatne / Papieros” na czytniku. Wyjścia przestają być bezpłatnym czasem pracy, a zespół widzi, że zasady są równe dla wszystkich.'},
    {t:'Długość przerw',d:'Limity przerw obowiązują, ale nikt ich nie mierzy.',s:'Automatyczny pomiar czasu trwania przerw. System sam pilnuje limitów i flaguje przekroczenia, oszczędzając Twoje pieniądze.'},
    {t:'Pytania o bilans urlopowy',d:'Kadry odpowiadają na te same pytania o dostępne dni wolne.',s:'Samoobsługowy portal pracowniczy. Każdy sprawdzi swój bilans urlopowy w swoim profilu w kilka chwil, bez angażowania kadr.'},
    {t:'Raport potrzebny od razu',d:'Zestawienie obecności trzeba przygotować ręcznie, gdy jest potrzebne natychmiast.',s:'Jedno kliknięcie i masz gotowy, pełny raport. Aktualne dane o obecnościach i czasie pracy dostajesz na ekranie tu i teraz.'},
    {t:'Te same dane wpisywane dwa razy',d:'Godziny z listy papierowej trafiają do programu kadrowego ręcznie.',s:'Automatyczny eksport danych do Twojego programu kadrowego (Optima, Enova, Symfonia i inne). Zero ręcznego przepisywania cyfr z kartek.'},
    {t:'Zamknięcie miesiąca',d:'Rozliczenie czasu pracy całej załogi trzeba zebrać przed terminem wypłat.',s:'Gotowy raport czasu pracy w kilkanaście minut dla całej załogi. System na bieżąco zlicza czas, nadgodziny, noce i spóźnienia. Kadry wreszcie zamykają miesiąc bez stresu.'},
  ...
  painsOutro:{t:'…to znak, że czas na jedno źródło danych o czasie pracy.',d:'System BioSys prowadzi ewidencję automatycznie i przekazuje gotowe dane do kadr — bez ręcznego przepisywania i bez pracy wykonywanej dwa razy.'},
...
},
{
  ...
  kdFor:[
    ...
    {n:'02', t:'Magazyny i centra logistyczne', c:'#14B8A6', ct:'#0D8577', tint:'rgba(20,184,166,.09)', line:'rgba(20,184,166,.28)', icon:'M3 8.5 12 4l9 4.5v7L12 20l-9-4.5zM3 8.5 12 13l9-4.5M12 13v7', tag:'Obsada i strefy', need:'Szybka weryfikacja obsady, kontrola dostępu do stref magazynowych, integracja z czasem pracy.', sol:'Jeden identyfikator do drzwi, bramek i rozliczenia godzin oraz podgląd obsady na hali w czasie rzeczywistym.'},
  ...
  kdAreas:[
    {num:'01', t:'Strefa wjazdu i strefa zewnętrzna', sub:'Obwód obiektu', badge:'PIERWSZA LINIA OBRONY',
    ...
    {num:'02', t:'Wejścia budynkowe i ruch pieszy', sub:'Recepcje i ciągi komunikacyjne', badge:'PŁYNNY RUCH',
    ...
    {num:'03', t:'Strefa produkcyjna, magazynowa i BHP', sub:'Procedury i higiena', badge:'BEZPIECZEŃSTWO PROCESU',
    ...
    {num:'04', t:'Pomieszczenia krytyczne i specjalne', sub:'Wysoki rygor bezpieczeństwa', badge:'NAJWYŻSZY RYGOR',
  ...
  kdZones:[
    {zone:'Produkcja — hala A', n:'128', state:'Dostęp otwarty', color:'#14B8A6'},
    {zone:'Magazyn wysoki', n:'34', state:'Dostęp otwarty', color:'#14B8A6'},
...
{
  key:'sol-tasktimer', tag:'Rozliczenie produkcji — TaskTimer', isSolution:true, kicker:'ROZWIĄZANIA BIOSYS',
  ...
  painsLead:'Wsparcie w procesie pomiaru Wskaźników w przedsiębiorstwie. System daje realną wiedzę, kluczową przy opracowywaniu niektórych Wskaźników Rezultatu (RI) oraz Wskaźników Efektywności (PI), a w efekcie Kluczowych Wskaźników Rezultatu (KRI) oraz Kluczowych Wskaźników Efektywności (KPI).',
  painTableHead:['KRI','RI','PI','KPI'],
  painTableRows:[
    {area:'Produkcja',cells:[
      ['Terminowa realizacja planu projektów'],
      ['Średni czas opóźnienia zleceń'],
      ['Poziom wykorzystania potencjału produkcyjnego'],
      ['Liczba przestojów produkcyjnych','Awarie','Liczba bieżących opóźnień planu produkcji']
    ]},
    {area:'Utrzymanie ruchu na produkcji',cells:[
      ['Liczba i czas awarii kluczowych maszyn'],
      ['Liczba i czas awarii wszystkich maszyn'],
      ['Liczba godzin przeznaczona na działania diagnostyczne','Liczba awarii dłuższych niż … min.'],
  ...
  painGroups:[
    ...
    {iconKey:'screen',title:'Nowoczesne podejście do projektów',sub:'',intro:'Wdrożenie systemu pozwala na stworzenie elektronicznej ewidencji i całkowite wyeliminowanie papierowej dokumentacji.',leadIn:'Przedsiębiorca zyskuje m.in.:',bullets:[
...
},
{
  ...
  heroVariant:'dashboard', featuresVariant:'list', hasForm:false,
...
},
{
  ...
  features:[
    {t:'Zgodność z Kodeksem Pracy',d:'System wyręcza i wspiera operatorów. Automatycznie informuje o ewentualnych niezgodnościach podczas planowania i rozliczania godzin, minimalizując ryzyko kontroli i roszczeń.'},
    {t:'Samoobsługa pracownicza',d:'Panel pracownika pozwala załodze samodzielnie sprawdzać limit urlopu, raporty obecności czy grafiki. Zdejmuje to z Kadr obowiązek ciągłego odpowiadania na rutynowe pytania.'},
    {t:'Integracja z systemami Kadrowo-Płacowymi',d:'Posiadamy gotowe interfejsy do wymiany danych (K-P). Eliminujemy ryzyko pomyłek przy ręcznym przepisywaniu godzin i skracamy czas zamknięcia miesiąca z kilku dni do kilku minut.'},
    {t:'Likwidacja papieru i realne oszczędności',d:'Odejście od list papierowych na rzecz elektronicznej, rzetelnej dokumentacji pracowniczej. Płacisz wyłącznie za faktycznie przepracowany czas, likwidując koszty spóźnień czy wcześniejszych wyjść.'}
  ],
...
},
{
  ...
  heroVariant:'dashboard', featuresVariant:'grid', hasForm:false,
...
},
{
  ...
  heroVariant:'security', featuresVariant:'grid', hasForm:true,
...
},
{
  ...
  heroVariant:'branches', featuresVariant:'list', hasForm:false,
...
const REF_CLIENTS = [
  {"n":"ADIENT","w":"Śląskie","b":["automotive","metal produkcja"],"s":"RCP, KD","m":"ewakuacja, web pracownik","i":"WF-GANG","r":true,"o":false,"f":""},
  {"n":"AOTiM","w":"Mazowieckie","b":["szpitale/ochrona zdrowia","budżetówka"],"s":"RCP","m":"SLA, integracja, system rozproszony","i":"Optima (Comarch)","r":true,"o":false,"f":""},
  {"n":"APTEKI CENTRUM","w":"Warmińsko-mazurskie","b":["handel","szpitale/ochrona zdrowia"],"s":"RCP","m":"system rozproszony","i":"","r":true,"o":false,"f":""},
  {"n":"ARCOM","w":"Małopolskie","b":["budownictwo/materiały/inżynieria"],"s":"RCP","m":"web pracownik, foto","i":"inne","r":true,"o":false,"f":""},
  {"n":"ARKA","w":"Zachodniopomorskie","b":["woda/armatura"],"s":"RCP","m":"integracja","i":"Optima (Comarch)","r":true,"o":false,"f":""},
  {"n":"ASSA ABLOY","w":"Wielkopolskie","b":["usługi"],"s":"RCP, KD","m":"integracja","i":"Enova (Soneta)","r":true,"o":false,"f":""},
  {"n":"B&B OPAKOWANIA","w":"Lubuskie","b":["metal produkcja"],"s":"RCP, KD","m":"web pracownik","i":"Enova (Soneta)","r":true,"o":true,"f":""},
  {"n":"BCP OLSZÓWKA","w":"Śląskie","b":["szpitale/ochrona zdrowia"],"s":"RCP","m":"web pracownik, foto, system rozproszony","i":"Infomedica","r":true,"o":false,"f":""},
  {"n":"BIBLIOTEKA JAGIELLOŃSKA W KRAKOWIE","w":"Małopolskie","b":["budżetówka"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"BIOMASA","w":"Wielkopolskie","b":["eko/zuk/recycling"],"s":"RCP","m":"system rozproszony, integracja","i":"Optima (Comarch)","r":true,"o":false,"f":""},
  {"n":"BITTNER","w":"Mazowieckie","b":["spożywka produkcja"],"s":"RCP","m":"SLA","i":"","r":true,"o":false,"f":""},
  {"n":"BIURO DO SPRAW SUBSTANCJI CHEMICZNYCH","w":"Łódzkie","b":["budżetówka"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"CEBI","w":"Śląskie","b":["metal produkcja"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"CONTEYOR","w":"Śląskie","b":["budownictwo/materiały/inżynieria"],"s":"RCP, KD","m":"web pracownik, ewakuacja","i":"","r":true,"o":false,"f":""},
  {"n":"CUKIERNIA BIAŁOGON","w":"Świętokrzyskie","b":["spożywka produkcja"],"s":"RCP","m":"web pracownik","i":"","r":true,"o":false,"f":""},
  {"n":"DALIAN TALENT","w":"Małopolskie","b":["tworzywa sztuczne/szkło produkcja"],"s":"RCP, KD","m":"web pracownik","i":"inne","r":true,"o":true,"f":""},
  {"n":"DCRiO","w":"Dolnośląskie","b":["szpitale/ochrona zdrowia"],"s":"RCP","m":"web pracownik, foto, SLA","i":"inne","r":true,"o":false,"f":""},
  {"n":"DENTIS","w":"Mazowieckie","b":["szpitale/ochrona zdrowia"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"DR GAJDA","w":"Zachodniopomorskie","b":["szpitale/ochrona zdrowia"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"EMITERNET","w":"Śląskie","b":["usługi","elektryka","eko/zuk/recycling"],"s":"RCP","m":"system rozproszony","i":"","r":true,"o":false,"f":""},
  {"n":"ESPEFA","w":"Małopolskie","b":["kosmetyki/farmacja/beauty"],"s":"RCP","m":"SLA","i":"","r":true,"o":false,"f":""},
  {"n":"EUROPAPIER","w":"Wielkopolskie","b":["elektryka"],"s":"RCP, KD","m":"web pracownik","i":"","r":true,"o":false,"f":""},
  {"n":"EUROPHARMA","w":"Dolnośląskie","b":["kosmetyki/farmacja/beauty"],"s":"RCP","m":"web pracownik","i":"","r":true,"o":false,"f":""},
  {"n":"GARDNER AEROSPACE","w":"Podkarpackie","b":["budownictwo/materiały/inżynieria"],"s":"KD","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"GRAND LUBICZ USTKA","w":"Pomorskie","b":["hotele"],"s":"RCP","m":"web pracownik, SLA","i":"Optima (Comarch)","r":true,"o":false,"f":""},
  {"n":"HERZ","w":"Małopolskie","b":["woda/armatura"],"s":"RCP","m":"integracja","i":"Optima (Comarch)","r":true,"o":false,"f":""},
  {"n":"INSTALACJE ST","w":"Mazowieckie","b":["tworzywa sztuczne/szkło produkcja"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"ISKRA ZMIŁS","w":"Świętokrzyskie","b":["metal produkcja"],"s":"RCP, KD","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"KLUB FITNESS","w":"Małopolskie","b":["usługi"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"LABOKLIN","w":"Mazowieckie","b":["szpitale/ochrona zdrowia"],"s":"RCP","m":"web pracownik","i":"","r":true,"o":false,"f":""},
  {"n":"LANDSTAL","w":"Łódzkie","b":["automotive"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"LINK2PEOPLE","w":"Mazowieckie","b":["usługi"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"LX PANTOS","w":"Mazowieckie","b":["logistyka/spedycja/transport"],"s":"RCP","m":"integracja, system rozproszony","i":"TETA","r":true,"o":false,"f":""},
  {"n":"MASTER-TECH","w":"Łódzkie","b":["logistyka/spedycja/transport","metal produkcja"],"s":"RCP, KD","m":"ewakuacja","i":"","r":true,"o":false,"f":""},
  {"n":"MEGAGROUP LOGISTIC","w":"Wielkopolskie","b":["logistyka/spedycja/transport"],"s":"RCP","m":"web pracownik","i":"","r":true,"o":false,"f":""},
  {"n":"MITSUI","w":"Opolskie","b":["automotive","metal produkcja"],"s":"RCP","m":"web pracownik","i":"Optima (Comarch)","r":true,"o":false,"f":""},
  {"n":"MUDEUNG","w":"Wielkopolskie","b":["elektryka"],"s":"RCP","m":"","i":"","r":true,"o":true,"f":""},
  {"n":"NACOMI","w":"Śląskie","b":["kosmetyki/farmacja/beauty"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"NOV-WELD","w":"Pomorskie","b":["usługi"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"ORKLA CARE","w":"Mazowieckie","b":["kosmetyki/farmacja/beauty"],"s":"RCP, KD","m":"foto","i":"","r":true,"o":false,"f":""},
  {"n":"PODGIK","w":"Wielkopolskie","b":["budżetówka"],"s":"RCP","m":"web pracownik, SLA","i":"","r":true,"o":false,"f":""},
  {"n":"POLAM","w":"Śląskie","b":["metal produkcja"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"POLAN","w":"Małopolskie","b":["spożywka produkcja"],"s":"RCP, KD","m":"integracja","i":"Optima (Comarch)","r":true,"o":true,"f":""},
  {"n":"POLFA LUBLIN","w":"Lubelskie","b":["kosmetyki/farmacja/beauty"],"s":"RCP, KD","m":"ewakuacja","i":"","r":true,"o":false,"f":""},
  {"n":"POMORSKA IZBA ARCHITEKTÓW","w":"Pomorskie","b":["budownictwo/materiały/inżynieria"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"PROZON","w":"Mazowieckie","b":["usługi","eko/zuk/recycling"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"RCKIK","w":"Dolnośląskie","b":["szpitale/ochrona zdrowia"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"REYNDERS","w":"Łódzkie","b":["papier"],"s":"RCP, KD","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"ROZBUD","w":"Podlaskie","b":["metal produkcja","budownictwo/materiały/inżynieria"],"s":"RCP","m":"system rozproszony, foto","i":"","r":true,"o":false,"f":""},
  {"n":"SPECKABLE","w":"Wielkopolskie","b":["budownictwo/materiały/inżynieria","elektryka"],"s":"RCP, KD","m":"web pracownik","i":"","r":true,"o":false,"f":""},
  {"n":"STAROSTWO POWIATOWE W BIAŁYMSTOKU","w":"Podlaskie","b":["budżetówka"],"s":"RCP","m":"SLA","i":"","r":true,"o":false,"f":""},
  {"n":"SUN GARDEN","w":"Wielkopolskie","b":["tworzywa sztuczne/szkło produkcja"],"s":"RCP, KD","m":"SLA","i":"","r":true,"o":false,"f":""},
  {"n":"ŚLĄSKIE CENTRUM USŁUG WSPÓLNYCH","w":"Śląskie","b":["budżetówka"],"s":"KD","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"TARSMAK","w":"Małopolskie","b":["spożywka produkcja"],"s":"RCP, KD","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"TECHNOTEX","w":"Dolnośląskie","b":["tekstylia/dziewiarstwo/ubrania"],"s":"RCP, KD","m":"web pracownik","i":"","r":true,"o":false,"f":""},
  {"n":"TOHO","w":"Mazowieckie","b":["automotive"],"s":"RCP","m":"foto","i":"","r":true,"o":false,"f":""},
  {"n":"TOLMET","w":"Łódzkie","b":["automotive","metal produkcja"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"UM ŁÓDZKIE","w":"Łódzkie","b":["budżetówka"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"URZĄD STATYSTYCZNY RZESZÓW","w":"Podkarpackie","b":["budżetówka"],"s":"RCP, KD","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"VITWORKER","w":"Kujawsko-pomorskie","b":["metal produkcja"],"s":"RCP, ZAD","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"WCPiT","w":"Wielkopolskie","b":["szpitale/ochrona zdrowia"],"s":"RCP","m":"","i":"","r":true,"o":false,"f":""},
  {"n":"WFOŚIGW W GDAŃSKU","w":"Pomorskie","b":["budżetówka"],"s":"RCP","m":"web pracownik","i":"","r":true,"o":false,"f":""},
  {"n":"WUP W WARSZAWIE","w":"Mazowieckie","b":["budżetówka"],"s":"RCP","m":"integracja, system rozproszony","i":"Quorum (QNT)","r":true,"o":false,"f":""},
  {"n":"XELLA","w":"Mazowieckie","b":["budownictwo/materiały/inżynieria"],"s":"KD","m":"ewakuacja","i":"","r":true,"o":false,"f":""},
  {"n":"ŻABCZYŃSCY","w":"Mazowieckie","b":["spożywka produkcja"],"s":"RCP, KD","m":"ewakuacja","i":"","r":true,"o":false,"f":""}
];
...
export const SITE = {
  ...
  faq: FAQ_ITEMS,
  refClients: REF_CLIENTS,
  clientLogos: CLIENT_LOGOS,
  integrationLogos: INTEGRATION_LOGOS,
  checklist: CHECKLIST,
  media: MEDIA
};
